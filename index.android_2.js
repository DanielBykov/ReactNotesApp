...
class TestScreen extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      dataSource: ds.cloneWithRows(obj1)
    };
  }
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.bg1}>Just Text</Text>
        <ListView
...
// 	  }
//   doAuth = function () {
// 	  restapi.doLogin(  this.formState.login.text,
//                       this.formState.password.text,
...
//     <TextInput ref="1"  onChangeText  = {(text) => this.formState.login={text}}
//                         autoFocus     = {true}
//                         placeholder   = "Login"
//                         returnKeyType = "next"
//                         autoCorrect   = {false}
//                         onSubmitEditing= {() => this.focusNextField('2')} />
//     <TextInput ref="2"  onChangeText   = {(text) => this.formState.password={text}}
//                         placeholder="Password"
//                         returnKeyType="done"
//                         secureTextEntry={true}
//                         autoCorrect={false}
//                         onSubmitEditing={() => this.doAuth()} />
//     <Button
//                         onPress={() => this.doAuth()}
//                         title="Login"
//         />
    ...
    return (
      <View>
        ...
        renderRow={
          (rowData) =>
            <TouchableHighlight
              onPress={() => navigate('Articles', { "d": rowData }) } >
              <Text style={styles.listviewitembig}>{rowData}</Text>
            </TouchableHighlight>}
        renderSeparator={(sectionId, rowId) => <View key={rowId} style={styles.separator} />}
      />
      </View>
...
const ReactBlogClient = StackNavigator({
  TestScreen123: { screen: TestScreen },
